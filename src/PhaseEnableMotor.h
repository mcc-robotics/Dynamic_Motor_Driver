...
#ifndef MOTORDRIVER_PHASEENABLEMOTOR_H
#define MOTORDRIVER_PHASEENABLEMOTOR_H
...
public:
  ...
  PhaseEnableMotor(uint8_t motPin1, uint8_t motPin2)
...
#endif // MOTORDRIVER_PHASEENABLEMOTOR_H
